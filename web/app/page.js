      ...
      <div className="content" style={{ fontSize: `${fontSize}px` }}>
        <div className="body">
          ...
          <div className="container">
            ...
            <UnityApp
              loaderUrl="./webgl1/Build/01_v3.0_webgl.loader.js"
              dataUrl="./webgl1/Build/01_v3.0_webgl.data"
              frameworkUrl="./webgl1/Build/01_v3.0_webgl.framework.js"
              codeUrl="./webgl1/Build/01_v3.0_webgl.wasm"
              className="webgl"
              id="unity-app-1"
            />     
          </div>
          ...
          <div className="container">
            <h2 className="title">仮説2）風通しのよさ：凹凸の間を空気が流れる</h2>
            ...
            <UnityApp
              loaderUrl="./webgl2/Build/02_v3.0_webgpu.loader.js"
              dataUrl="./webgl2/Build/02_v3.0_webgpu.data"
              frameworkUrl="./webgl2/Build/02_v3.0_webgpu.framework.js"
              codeUrl="./webgl2/Build/02_v3.0_webgpu.wasm"
              className="webgl"
              id="unity-app-2"
            />
          </div>
